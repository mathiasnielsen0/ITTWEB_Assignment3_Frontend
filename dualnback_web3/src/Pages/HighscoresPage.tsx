...
export default class HighscoresPage extends React.Component<IProps, IState> {
    ...
    componentDidMount(): void {
        ...
        for (let i = 0; i < 10; i++) {
            this.sc[i] = <ScoreCard key={i} index={i+1} username={"Hans"} score={100}/>
        }
    ...
    addScore = () =>{
        ...
        this.sc[this.sc.length] = <ScoreCard key={this.sc.length+1} index={this.sc.length} username={"Hansel"} score={300} />
